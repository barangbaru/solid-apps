...
RELEASE_NOTES = (
    "v2.2.108: Memperbaiki keterbacaan menu Audit Trail dengan menerapkan tema warna ungu premium terpadu, mendesain tab navigasi sebagai modern segmented control (pills), serta meningkatkan rasio kontras warna header tabel logs. "
